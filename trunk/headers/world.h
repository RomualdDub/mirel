...
{
    public:
    World(Gfx* ingfx, Xml* inxml, int worldindex);
    ~World();
...
World::World(Gfx* ingfx, Xml* inxml, int worldindex)
{
    gfx = ingfx;

    inxml->readworlds(worldindex);

    gfx->loadworld(worldindex, inxml->worldsplit);
