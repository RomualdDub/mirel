...
#define GFX_COIN2 9
#define GFX_COIN3 10
#define GFX_DIALOGCORNER 11
#define GFX_DIALOGDOT 12
#define GFX_DIALOGEXTENSION 13
#define GFX_DRESS0 14
#define GFX_DRESS1 15
#define GFX_DRESS2 16
#define GFX_EMOTEAGGRO 17
#define GFX_EMOTEDEAD 18
#define GFX_EMOTEFEAR 19
#define GFX_FEET0 20
#define GFX_FEET1 21
#define GFX_FEET2 22
#define GFX_FX0 23
...
#define GFX_HEAD1 26
#define GFX_HEAD2 27
#define GFX_INTERFACE 28
#define GFX_MINIHP 29
#define GFX_MOB0 30
#define GFX_POTIONL 31
#define GFX_POTIONM 32
#define GFX_PYRO0 33
#define GFX_SKY0 34
#define GFX_STATE 35
#define GFX_WAND0 36
#define GFX_WAND1 37
#define GFX_WAND2 38
#define GFX_WORLD01 39
#define GFX_WORLD02 40
#define GFX_WORLD03 41
#define GFX_WORLDCOLLIDE01 42
#define GFX_WORLDCOLLIDE02 43
#define GFX_WORLDCOLLIDE03 44
#define GFX_WORLDOCCLUDE01 45
#define GFX_WORLDOCCLUDE02 46
#define GFX_WORLDOCCLUDE03 47
#define GFX_ZUZU0 48
#define GFX_ZUZU1 49
#define GFX_ZUZU2 50
#define GFX_ZUZU3 51
...
int main()
{
    ...
    Map* map = new Map();
    Scene* scene = new Scene(xml->infoherox, xml->infopetx, map);
    ...
    while (app.IsOpened())
    {
        ...
        while (app.GetEvent(event))
        {
            ...
            if (event.Type == sf::Event::KeyPressed)
            {
                ...
                else if (sys->resetkeys)
                {
                    sys->resetkeys = false;
                    xml->keyleft = sys->keyleft = sf::Key::Q;
                    xml->keyright = sys->keyright = sf::Key::D;
                    xml->keyjump = sys->keyjump = sf::Key::Z;
                    xml->keyaction = sys->keyaction = sf::Key::Space;
                    xml->keypet = sys->keypet = sf::Key::A;
                }
                else
                {
