...
Hero::Hero()
{
    ...
    wandsurface[0] = IMG_Load("gfx/wand0.png");
    wandsurface[1] = IMG_Load("gfx/wand1.png");
    wandsurface[2] = IMG_Load("gfx/wand2.png");
    ...
    blit(surface[HEROWALK0], wandsurface[0]);
    ...
    blit(surface[HEROWALK1], wandsurface[0]);
    ...
    blit(surface[HEROWALK2], wandsurface[0]);
    ...
    blit(surface[HEROATK0], wandsurface[0]);
    ...
    blit(surface[HEROATK1], wandsurface[1]);
    ...
    blit(surface[HEROATK2], wandsurface[2]);
    ...
    blit(surface[HEROIDLE], wandsurface[0]);
    ...
    blit(surface[HEROJUMP], wandsurface[0]);
    ...
    SDL_FreeSurface(wandsurface[0]);
    SDL_FreeSurface(wandsurface[1]);
    SDL_FreeSurface(wandsurface[2]);
...
void Hero::draw()
{
    ...
    glBegin(GL_QUADS);
        ...
        glTexCoord2d(0, 0); glVertex2i(0, 64);
        glTexCoord2d(1, 0); glVertex2i(64, 64);
        glTexCoord2d(1, 1); glVertex2i(64, -64);
    glEnd();
