...
void Mob::draw()
{
    ...
    glBegin(GL_QUADS);
        ...
        glTexCoord2d(0, 1); glVertex2i(0, size - basesize / 2);
            glColor3d(1, 1, 1);
        glTexCoord2d(0, 0); glVertex2i(0, size / 2 + basesize / 2);
        glTexCoord2d(1, 0); glVertex2i(size + basesize, size / 2 + basesize / 2);
        if (aggro && !hit)
            glColor3d(1, 0, 0);
        else if (fear && !hit)
            glColor3d(0, 0.5, 1);
        glTexCoord2d(1, 1); glVertex2i(size + basesize, size - basesize / 2);
            glColor3d(1, 1, 1);
    glEnd();
