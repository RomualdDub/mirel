    ...
    else
    {
        ...
        else // bobo talks
        {
            ...
            if (sys->configurekeys)
            {
                ...
                {
                    dialogs.clear();
                    dialogs.push_back(new Dialog(gfx, "simple", "Press 'Left' key..."));
                }
                else if (!sys->keyright)
                {
                    dialogs.clear();
                    dialogs.push_back(new Dialog(gfx, "simple", "Press 'Right' key..."));
                }
                else if (!sys->keyjump)
                {
                    dialogs.clear();
                    dialogs.push_back(new Dialog(gfx, "simple", "Press 'Jump' key..."));
                }
                else if (!sys->keyaction)
                {
                    dialogs.clear();
                    dialogs.push_back(new Dialog(gfx, "simple", "Press 'Action' key..."));
                }
                else if (!sys->keypet)
                {
                    dialogs.clear();
                    dialogs.push_back(new Dialog(gfx, "simple", "Press 'Pet control' key..."));
                }
                else
                {
...
{
    if (!ishelp)
        dialogs.push_back(new Dialog(gfx, "simple", message));
}
...
void Bobo::help()
{
    ishelp = true;
    dialogs.clear();
    dialogs.push_back(new Dialog(gfx, "bobo_options", "How can I help you ?", options, x, y, sys));
}
