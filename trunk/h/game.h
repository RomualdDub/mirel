    ...
    if (sys->useitem)
    {
        ...
        else
        {
            ...
            else if (inv->items[sys->itemindex]->type == "hat")
            {
                ...
                inv->items[(int)inv->items.size() - 1]->setstats(xml->infohatincrementation, xml->currentitems[0]->bonus);
            ...
            else if (inv->items[sys->itemindex]->type == "wand")
            {
                ...
                inv->items[(int)inv->items.size() - 1]->setstats(xml->infowandincrementation, xml->currentitems[2]->bonus);
