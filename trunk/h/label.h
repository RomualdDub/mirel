...
{
    public:
    Label(Gfx* ingfx, Xml* xml);
    Label(Gfx* ingfx, Xml* xml, Pet* pet);
...
Label::Label(Gfx* ingfx, Xml* xml, Pet* pet)
{
    gfx = ingfx;
