...
{
    public:
    Scene(Gfx* ingfx, Bobo* inbobo, Xml* inxml, Game* ingame, Map* inmap, System* insys);
    ~Scene();
...
Scene::Scene(Gfx* ingfx, Bobo* inbobo, Xml* inxml, Game* ingame, Map* inmap, System* insys)
{
    gfx = ingfx;
    bobo = inbobo;
    xml = inxml;
