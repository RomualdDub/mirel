...
void Game::draw()
{
    ...
    glBegin(GL_QUADS);
        ...
        glTexCoord2d(0, 0); glVertex2i(0, 21);
        glTexCoord2d(1, 0); glVertex2i(256, 21);
        glTexCoord2d(1, 1); glVertex2i(256, -21);
    glEnd();
    ...
    glBegin(GL_QUADS);
        ...
        glTexCoord2d(1, 0); glVertex2i(113, 64);
        glTexCoord2d(1, 1); glVertex2i(113, -64);
    glEnd();
    ...
    glBegin(GL_QUADS);
        ...
        glTexCoord2d(1, 0); glVertex2i(len * 16, 16);
        glTexCoord2d(1, 1); glVertex2i(len * 16, -16);
    glEnd();
    ...
    glBegin(GL_QUADS);
        glTexCoord2d(0, 1); glVertex2i(0, -16);
        glTexCoord2d(0, 0); glVertex2i(0, 16);
        glTexCoord2d(1, 0); glVertex2i(len * 8, 16);
        glTexCoord2d(1, 1); glVertex2i(len * 8, -16);
    glEnd();
    ...
    glBegin(GL_QUADS);
        glTexCoord2d(0, 1); glVertex2i(0, -64);
        glTexCoord2d(0, 0); glVertex2i(0, 64);
        glTexCoord2d(1, 0); glVertex2i(800, 64);
        glTexCoord2d(1, 1); glVertex2i(800, -64);
    glEnd();
}
