...
Gfx::Gfx()
{
    ...
    emoteimages.push_back(sf::Image());
    emoteimages[1].LoadFromFile("gfx/emote_dead.png");
    emoteimages.push_back(sf::Image());
    emoteimages[2].LoadFromFile("gfx/emote_fear.png");
    emote_aggro = 0;
    emote_dead = 1;
    emote_fear = 2;
...
void Gfx::loadhero()
{
    ...
    dressimages[0].LoadFromFile("gfx/dress001_1.png");
    dressimages.push_back(sf::Image());
    dressimages[1].LoadFromFile("gfx/dress001_2.png");
    dressimages.push_back(sf::Image());
    dressimages[2].LoadFromFile("gfx/dress001_3.png");
    wandimages.push_back(sf::Image());
    wandimages[0].LoadFromFile("gfx/wand001_1.png");
    wandimages.push_back(sf::Image());
    wandimages[1].LoadFromFile("gfx/wand001_2.png");
    wandimages.push_back(sf::Image());
    wandimages[2].LoadFromFile("gfx/wand001_3.png");
...
void Gfx::loadboss()
{
    ...
    bossimages[0].LoadFromFile("gfx/boss001.png");
...
void Gfx::loadmob()
{
    ...
    mobimages[0].LoadFromFile("gfx/mob001.png");
...
void Gfx::loadworld()
{
    ...
    worldskyimages[0].LoadFromFile("gfx/world_sky001.png");
    worldskyimages[0].SetSmooth(false);

    worldbgimages.push_back(sf::Image());
    worldbgimages[0].LoadFromFile("gfx/world_bg001_1.png");
    worldbgimages.push_back(sf::Image());
    worldbgimages[1].LoadFromFile("gfx/world_bg001_2.png");
    worldbgimages.push_back(sf::Image());
    worldbgimages[2].LoadFromFile("gfx/world_bg001_3.png");

    for (int i = 0; i < (int)worldbgimages.size() - 1; i++)
        worldbgimages[i].SetSmooth(false);

    worldcollideimages.push_back(sf::Image());
    worldcollideimages[0].LoadFromFile("gfx/world_collide001_1.png");
    worldcollideimages.push_back(sf::Image());
    worldcollideimages[1].LoadFromFile("gfx/world_collide001_2.png");
    worldcollideimages.push_back(sf::Image());
    worldcollideimages[2].LoadFromFile("gfx/world_collide001_3.png");

    vector<sf::Image>worldmaskimages;
    worldmaskimages.push_back(sf::Image());
    worldmaskimages[0].LoadFromFile("gfx/world_occlude001_1.png");
    worldmaskimages.push_back(sf::Image());
    worldmaskimages[1].LoadFromFile("gfx/world_occlude001_2.png");
    worldmaskimages.push_back(sf::Image());
    worldmaskimages[2].LoadFromFile("gfx/world_occlude001_3.png");
    ...
    sf::Color color(0, 0, 0, 0);
    worldoccludeimages[0].Create(800, 472, color);
    worldoccludeimages[0].SetSmooth(false);
    worldoccludeimages[1].Create(800, 472, color);
    worldoccludeimages[1].SetSmooth(false);
    worldoccludeimages[2].Create(800, 472, color);
    worldoccludeimages[2].SetSmooth(false);
