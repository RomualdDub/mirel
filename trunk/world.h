...
void World::draw()
{
    ...
    glBegin(GL_QUADS);
        ...
        glTexCoord2d((double)skyx / 800.0 - 0, 0); glVertex2i(0, 236);
        glTexCoord2d((double)skyx / 800.0 - 3, 0); glVertex2i(2400, 236);
        glTexCoord2d((double)skyx / 800.0 - 3, 1); glVertex2i(2400, -236);
    glEnd();
