...
{
    public:
    Loot(Gfx* ingfx, Snd* insnd, Xml* inxml, string intype, int inlevel, float inx, float iny);
    ~Loot();
...
Loot::Loot(Gfx* ingfx, Snd* insnd, Xml* inxml, string intype, int inlevel, float inx, float iny)
{
    gfx = ingfx;
    snd = insnd;
    xml = inxml;
